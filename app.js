...
Gallery.prototype.openModal = function(selectedImage , list){
  ...
  this.modalImage.innerHTML = list.map(function(image){
  ...
  this.modalImage.addEventListener('click',this.selecteImage);
...
Gallery.prototype.closeModal = function(){
  ...
  this.modalImage.removeEventListener('click',this.selecteImage);
}
...
Gallery.prototype.selecteImage = function(e){
...
const natrue = new Gallery(getElement('.natrue'));
